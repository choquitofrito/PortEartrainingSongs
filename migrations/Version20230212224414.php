 ...
 */
final class Version20230212224414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE song (id INT AUTO_INCREMENT NOT NULL, library_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, original_tempo INT DEFAULT NULL, original_tonality VARCHAR(5) DEFAULT NULL, file_link VARCHAR(255) DEFAULT NULL, INDEX IDX_33EDEEA1FE2541D7 (library_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
